...
type
    ...
    function ContarItens: Integer;
        ...
        public
          ...
          procedure setUmaContaPagar(vUmaContaPAgar:TContaPagar);
          ...
          function getUmaContaPagar:TContaPagar;
          ...
          property UmaContaPagar:TContaPagar read getUmaContaPagar write setUmaContaPagar;
...
begin
    Result:= FUmaListaContaPagar.Items[Index];
end;
...
function TCompra.getUmaContaPagar: TContaPagar;
begin
    Result:=FUmaContaPagar;
end;
...
begin
    FUmaListaContaPagar.Delete(Index);
end;
...
procedure TCompra.setUmaContaPagar(vUmaContaPAgar: TContaPagar);
begin
    FUmaContaPagar:=vUmaContaPAgar;
end;
...
begin
   FUmaListaContaPagar.Add(vUmaListaContaPagar)
end;
