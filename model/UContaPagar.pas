...
function TContaPagar.getDesconto: Double;
begin
  Result:=FDesconto;
end;

function TContaPagar.getJuros: Double;
begin
    Result:=FJuros;
end;
...
function TContaPagar.getValor: Double;
begin
   Result:=FValor;
end;

function TContaPagar.getValorTotalNOta: Double;
begin
   Result:=FValorTotal;
end;
...
procedure TContaPagar.setDesconto(vDesconto: Double);
begin
    FDesconto:=vDesconto;
end;

procedure TContaPagar.setJuros(vJuros: Double);
begin
    FJuros:=vJuros;
end;
...
procedure TContaPagar.setValor(vValor: Double);
begin
   FValor:=vValor;
end;

procedure TContaPagar.setValorTotalNOta(vValorTotalNota: Double);
begin
