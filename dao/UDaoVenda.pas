...
begin
               ...
               begin
                 ...
                 begin
                    ...
                    begin
                       ...
                       ShowMessage('ERRO DE ATUALIZAÇÃO DE ESTOQUE, QUANTIDADE SOLICITADA MAIOR QUE A A QUANTIDADE DISPONÍVEL.');
                       Exit;
                    end
                    else
                    begin
                        ...
                        begin
                          FDM.IBTransaction1.RollbackRetaining;
                          ShowMessage('ERRO DE ATUALIZAÇÃO DE ESTOQUE, SALDO DE ESTOQUE NEGATIVO.');
                          Exit;
                        end
    ...
    Except
      FDM.IBTransaction1.RollbackRetaining;
      MSG:='ERRO AO SALVAR VENDA. VERIFIQUE SE JÁ NÃO EXISTE UMA VENDA CADASTRADA COM ESTE NUMERO DE NOTA E SÉRIE.'
    end;
    Result:=MSG;
end;
