...
begin
  ...
  UmaCP.UmaFP.FP:=FDM.IBDataSetCondicaoPagamentoFORMAPAGAMENTO.Value;
...
begin
  ...
  try
     ...
     begin
          ...
          FDM.IBDataSetParcelaDATACADASTRO.Value:= Now;//StrToDate(UmaCPG.getParcelas(i-1).DataCadastro);
     ...
     MSG:='CONDIÇÃO DE PAGAMENTO SALVA COM SUCESSO';
  except
    FDM.IBTransaction1.RollbackRetaining;
    MSG:='ERRO AO SALVAR CONDIÇÃO DE PAGAMENTO';
  end;
  Result:=MSG;
end;
