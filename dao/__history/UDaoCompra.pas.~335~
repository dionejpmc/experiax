...
var SQL:string;
begin
       SQL:='SELECT * FROM COMPRA WHERE DATAENTRADA >='+Data1+' AND DATAENTRADA <= '+Data2;
...
try
     ...
     begin
      ...
      MSG:='ERRO AO SALVAR COMPRA. VERIFIQUE SE JÁ NÃO EXISTE UMA COMPRA CADASTRADA COM ESTE NUMERO DE NOTA E SÉRIE PARA ESTE FORNECEDOR.'
