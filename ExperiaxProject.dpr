...
uses
  ...
  UCtrlEstado in 'controll\UCtrlEstado.pas',
  ...
  UFrmConsultarCliente in 'view\UFrmConsultarCliente.pas' {FrmConsultarCliente},
  ...
  UCtrlCidade in 'controll\UCtrlCidade.pas',
  UDaoCidade in 'dao\UDaoCidade.pas',
  UClienteFisico in 'model\UClienteFisico.pas',
  UPessoa in 'model\UPessoa.pas',
  UPessoaFisica in 'model\UPessoaFisica.pas',
  UPessoaJuridica in 'model\UPessoaJuridica.pas',
  UFuncionario in 'model\UFuncionario.pas',
  UFornecedor in 'model\UFornecedor.pas',
  UReceita in 'model\UReceita.pas',
  UProduto in 'model\UProduto.pas',
  UOrdemProducao in 'model\UOrdemProducao.pas',
  UDaoCargo in 'dao\UDaoCargo.pas',
  UCtrlCargo in 'controll\UCtrlCargo.pas',
  UFrmCadastroCargo in 'view\UFrmCadastroCargo.pas' {TFrmCadastroCargo},
  UFrmConsultarCargo in 'view\UFrmConsultarCargo.pas' {TFrmConsultarCargo},
  UCargo in 'model\UCargo.pas',
  UDaoFuncionario in 'dao\UDaoFuncionario.pas',
  UCtrlFuncionario in 'controll\UCtrlFuncionario.pas',
  UDaoProduto in 'dao\UDaoProduto.pas',
  UCtrlProduto in 'controll\UCtrlProduto.pas',
  UDaoReceita in 'dao\UDaoReceita.pas',
  UCtrlReceita in 'controll\UCtrlReceita.pas',
  UDaoFornecedor in 'dao\UDaoFornecedor.pas',
  UCtrlFornecedor in 'controll\UCtrlFornecedor.pas',
  UContaReceber in 'model\UContaReceber.pas',
  UVenda in 'model\UVenda.pas',
  UCompra in 'model\UCompra.pas',
  UCaixa in 'model\UCaixa.pas',
  UFormaPagamento in 'model\UFormaPagamento.pas' {$R *.res},
  UCondicaoPagamento in 'model\UCondicaoPagamento.pas',
  UContaPagar in 'model\UContaPagar.pas',
  UCtrlFP in 'controll\UCtrlFP.pas',
  UDaoFP in 'dao\UDaoFP.pas',
  UDaoCP in 'dao\UDaoCP.pas',
  UCtrlCP in 'controll\UCtrlCP.pas',
  UParcela in 'model\UParcela.pas',
  UCtrlCliente in 'controll\UCtrlCliente.pas',
  UDaoCliente in 'dao\UDaoCliente.pas',
  UCtrlCompra in 'controll\UCtrlCompra.pas',
  UFornecedorFisico in 'model\UFornecedorFisico.pas',
  ...
  UCtrlContaPagar in 'controll\UCtrlContaPagar.pas',
  UDaoContaPagar in 'dao\UDaoContaPagar.pas',
  UCtrlVenda in 'controll\UCtrlVenda.pas',
  UDaoVenda in 'dao\UDaoVenda.pas',
  UClienteJuridico in 'model\UClienteJuridico.pas',
  UAplica in 'UAplica.pas',
  UInterface in 'UInterface.pas',
  UProjectExperiax in 'UProjectExperiax.pas' {ProjectExperiax},
  UCtrlContaReceber in 'controll\UCtrlContaReceber.pas',
  UDaoContaReceber in 'dao\UDaoContaReceber.pas',
  UCheca_IE_ALL_UF_BR in 'UtilsServices\UCheca_IE_ALL_UF_BR.pas',
  UFrmBaixarProduto in 'view\UFrmBaixarProduto.pas' {FrmBaixarProduto},
  UCtrlOrdemProducao in 'controll\UCtrlOrdemProducao.pas',
  UDaoOrdemProducao in 'dao\UDaoOrdemProducao.pas',
  UDM in 'dbexperiax\UDM.pas' {DataModule1: TDataModule},
  UFrmRelatorioCompra in 'relatorios\UFrmRelatorioCompra.pas' {FrmRelatorioCompra},
  UFrmSelecionarCompraBYData in 'relatorios\UFrmSelecionarCompraBYData.pas' {FrmSelectByData};
