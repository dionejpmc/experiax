...
function TCtrlFornecedor.Carregar(Objeto: TObject;Id:integer): Tobject;
begin
   Result:= UmaDaoFornecedor.Carregar(Objeto,id);
end;
...
function TCtrlFornecedor.GetTipoFornecedor: string;
begin
   Result:=UmaDaoFornecedor.TipoFornecedor;
end;
