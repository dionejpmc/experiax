...
function TCtrlReceita.BuscarProduto(KeyId: Integer): Boolean;
begin
     Result:=UmaDaoReceita.BuscarProduto(KeyId);
end;
...
function TCtrlReceita.Salvar(Objeto: TObject): string;
begin
     Result:=UmaDaoReceita.Salvar(Objeto);
end;
