inherited FrmCadastroFuncionario: TFrmCadastroFuncionario
  ...
  object TLblIdFuncionario: TRzLabel [4]
    Left = 8
    Top = 11
    Width = 94
    Height = 13
  ...
  object TEdtFuncionario: TRzEdit [8]
    Left = 272
    Top = 8
    Width = 336
    Height = 21
    ...
    MaxLength = 50
    TabOrder = 1
    OnExit = TEdtFuncionarioExit
    OnKeyPress = TEdtFuncionarioKeyPress
  end
  object TEdtcargo: TRzEdit [9]
    Left = 272
    Top = 51
    Width = 244
    Height = 21
  ...
  object TBtnBuscarCargo: TRzBitBtn [10]
    Left = 535
    Top = 48
    Caption = 'Buscar'
    TabOrder = 4
  ...
  object TGroupBoxEnderecoFuncionario: TRzGroupBox [11]
    Left = 8
    Top = 88
    Width = 601
    Height = 168
    ...
    object TEdtLogradouro: TRzEdit
      ...
      OnKeyPress = TEdtLogradouroKeyPress
    end
    ...
    object TEdtObservacoe: TRzEdit
      ...
      MaxLength = 50
      TabOrder = 7
      OnKeyPress = TEdtObservacoeKeyPress
    end
  ...
  object TGroupBoxContatoFuncionario: TRzGroupBox [12]
    Left = 8
    Top = 262
    Width = 602
    Height = 90
    Caption = 'DADOS DE CONTATO DE FUNCIONARIO'
    TabOrder = 6
    ...
    object TEdtTelefoneResidencial: TRzMaskEdit
      Left = 152
      Top = 24
      Width = 129
      Height = 21
  ...
  object TEdtIdCargo: TRzEdit [16]
    ...
    MaxLength = 5
    TabOrder = 2
    OnExit = TEdtIdCargoExit
    OnKeyPress = TEdtIdCargoKeyPress
  end
  object RzGroupBox1: TRzGroupBox [17]
    Left = 8
    Top = 358
    Width = 602
    Height = 147
    ...
    TabOrder = 7
    object TLblDataAdmicao: TRzLabel
      Left = 15
      Top = 124
      Width = 109
      Height = 13
    ...
    object TLblDataDemição: TRzLabel
      Left = 337
      Top = 124
      Width = 99
      Height = 13
      Caption = 'Data de Demi'#231#227'o'
      Transparent = True
    end
    ...
    object TLblDataNascimento: TRzLabel
      Left = 337
      Top = 84
      Width = 108
      Height = 13
    ...
    object TRadioGroupSexo: TRzRadioGroup
      Left = 213
      Top = 11
      Width = 97
      Height = 66
      Caption = 'Sexo *'
      TabOrder = 2
      object TRadioBtnMasculino: TRzRadioButton
        Left = 8
        Top = 16
        Width = 74
        Height = 15
      ...
      object TRadioBtnFeminino: TRzRadioButton
        Left = 8
        Top = 37
        Width = 70
        Height = 15
        ...
        TabOrder = 1
        Transparent = True
        TransparentColor = clWindowText
      end
    end
    object TEdtCTPS: TRzEdit
      Left = 63
      Top = 81
      Width = 121
      Height = 21
    ...
    object TDateTimeDataAdmicao: TRzDateTimePicker
      Left = 137
      Top = 119
      Width = 136
      Height = 21
      Date = 41211.648728159720000000
      Time = 41211.648728159720000000
      TabOrder = 4
      FrameHotTrack = True
      FrameVisible = True
    end
    object tGroupBoxStatus: TRzGroupBox
      Left = 491
      Top = 11
      Width = 96
      Height = 66
      Caption = 'Status *'
      TabOrder = 3
      object TRadioBtnAtivo: TRzRadioButton
        Left = 8
        Top = 16
        Width = 48
        Height = 15
        ...
        TabStop = True
        Transparent = True
        OnClick = TRadioBtnAtivoClick
      end
      object TRadioBtnInativo: TRzRadioButton
        Left = 9
        Top = 37
        Width = 59
        Height = 15
        ...
        Transparent = True
        Visible = False
        OnClick = TRadioBtnInativoClick
      end
    end
    object TDateTimeDataDemicao: TRzDateTimePicker
      Left = 460
      Top = 119
      Width = 127
      Height = 21
      Date = 41211.811800358800000000
      Time = 41211.811800358800000000
      TabOrder = 5
      FrameHotTrack = True
      FrameVisible = True
    end
    object TEdtCPF: TRzMaskEdit
      Left = 63
      Top = 48
      Width = 120
      Height = 21
    ...
    object TDateTimePickerDataNascimento: TRzDateTimePicker
      Left = 460
      Top = 81
      Width = 127
      Height = 21
      Date = 41211.838335636570000000
      Time = 41211.838335636570000000
      TabOrder = 7
    end
  end
  object TEdtIdFuncionario: TRzEdit [18]
    Left = 111
    Top = 10
    Width = 55
    Height = 21
