...
uses
  ...
  UCtrlCliente, UCheca_IE_All_UF_BR, dxSkinsCore, dxSkinBlack, dxSkinBlue,
...
begin
  ...
  begin
    if UmaCtrlCliente.GetTipoCliente = 'Juridico' then
        UmClienteJuridico:=TClienteJuridico(UmaCtrlCliente.Carregar(UmClienteJuridico))
    else
        UmClienteFisico:=TClienteFisico(UmaCtrlCliente.Carregar(UmClienteFisico));
  end;
  Close;
end;
