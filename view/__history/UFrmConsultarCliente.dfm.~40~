inherited FrmConsultarCliente: TFrmConsultarCliente
  ...
  object TLblIdCidade: TRzLabel [1]
    Left = 8
    Top = 8
    Width = 20
    Height = 13
  ...
  object TGroupBoxCliente: TRzGroupBox [7]
    Left = 8
    Top = 35
    Width = 569
    Height = 193
    ...
    TabOrder = 7
    object TDBGridCliente: TRzDBGrid
      Left = 16
      Top = 32
      Width = 545
      Height = 145
      DataSource = DataModule1.TDataSourceCliente
      DefaultDrawing = True
      TabOrder = 0
  ...
  object TEdtIdCidade: TRzEdit [10]
    Left = 52
    Top = 8
    Width = 65
    Height = 21
