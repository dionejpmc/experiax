...
begin
  ...
  begin
        Self.TDateTimePickerDataEmicaoNota.DateTime:= Now;
        ShowMessage('A DATA DE EMISSÃO NÃO PODE SER MAIOR QUE A DATA DE ENTRADA.');
  end;
  if Self.TDateTimePickerDataEmicaoNota.DateTime > (now+0.1) then
  begin
     Self.TDateTimePickerDataEmicaoNota.DateTime:= Now;
     ShowMessage('A DATA DE EMISSÃO NÃO PODE SER MAIOR QUE  A DATA DE HOJE.');
  end;
...
begin
        ...
        BEGIN
          ShowMessage('FUNCIONALIDADE NÃO IMPLEMENTADA.');
        END;
...
begin
  ...
  if Self.TDateTimePickerDataEmicaoNota.DateTime > (Now + 0.1) then
  begin
    ShowMessage('A  DATA DE ENTRADA NÃO DEVE SER MAIOR QUE A DATA DE HOJE.');
    Self.TDateTimeDataEntrada.DateTime:=Now;
  end;
end;
