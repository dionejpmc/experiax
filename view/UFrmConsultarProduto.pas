...
begin
  ...
  if (Self.TBtnCancelar.Caption = 'SelecionarR') then
      UmaCtrlProduto.BuscarProduto(3);
...
begin
  inherited;
  if (Self.TBtnCancelar.Caption = 'Selecionar') or (Self.TBtnCancelar.Caption = '&Cancelar') or (Self.TBtnCancelar.Caption = 'Cancelar') then
  begin
  ...
  else if (Self.TBtnCancelar.Caption = 'SelecionarR') then
  begin
      if Self.TEdtId.Text <> '' then
         UmaCtrlProduto.BuscarProduto(3);
      if Self.TEdtProduto.Text <> '' then
